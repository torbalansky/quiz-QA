      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg">
          <div className="p-6 border-b border-gray-200">
            <h1 className="text-3xl font-bold text-gray-800">Test-Driven Development with Jest</h1>
            <p className="mt-2 text-gray-600">A comprehensive guide to testing React applications with Jest</p>
          ...
          <div className="p-6 space-y-8">
            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-3">What is Jest?</h2>
      ...
      "\\\\.(css|less|scss)$": "identity-obj-proxy"
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <div className="bg-gray-50 p-4 rounded-md font-mono text-xs mt-4">
